...
public class LoginService extends AsyncTask<String, Void, String> {
    ...
    protected String doInBackground(String... str) {
        try {
            ...
            String link = "http://app.compsat.org/index.php/Loginvalidation_controller/login/format/json";
        ...
        try {
            ...
            if(statusCode == 200){
                ...
                if(jsonObject.length() == 1){
                    ...
                    prefs.edit().putString("name", map.get("name"))
                            .apply();
                    prefs.edit().putString("course", map.get("course"))
                            .apply();
                    prefs.edit().putString("email", map.get("email"))
                            .apply();
                    prefs.edit().putString("mobile", map.get("mobile"))
                            .apply();
